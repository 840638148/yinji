...
<header class="mobile_header hide">
    <section class="mheader_main header_animated headroom--top headroom--not-bottom"> 
        ...
        <!--LOGO-->
        <h1 style='width:155px;border-right:1px solid rgba(255,255,255,.3);'> <a href="/" class="logo" title="发现全球设计之美-{{trans('comm.yinji')}}"><img src="/images/logo.png" alt="{{trans('comm.yinji')}}" style='margin-top:18px;'></a> </h1>
        <!--LOGOend--> 
    </section>
</header>
