...
@section('title')
  {{trans('comm.yinji')}} -  TA {{trans('index.fans')}}
@endsection
  ...
  <div class="home_nav" style='width:610px;left:52%;'>
    <ul>
        <li><a href="/member/{{$users->id}}">{{trans('index.home_page')}}</a></li>
	      ...
	      <li class="current"><a href="/member/homepage_fans/{{$users->id}}">{{trans('index.fans')}}</a></li>
    </ul>
  </div>
</div>
<section class="wrapper" style='width:1245px;'>
    <div class="mt30 home_box">
        <div class="title" style='height:44px;'>
            <h2 class="fl" style='line-height:40px;'><span style='border-bottom:2px solid #3d87f1;padding-bottom:11px;font-size:18px;'>TA {{trans('index.fans')}}</span></h2>
        </div>
        <!-- TA的粉丝开始 -->
        <div class="masonry" > 
