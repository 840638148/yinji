  ...
  <div class="mt30 home_box">
    ...
    <div class="down" style="margin-bottom:20px; border-bottom:1px solid #eee; float:left; width:100%">
      ...
      <div class="downright" style="float: left;margin-left: 100px;">
        <p style="margin-top:0px;">下载地址:<a href="{{mb_substr($v->vip_download,0,-10)}}" target="_blank">{{mb_substr($v->vip_download,0,-10)}}</a> </p>
        <p style="margin-top:5px;">提取密码:{{mb_substr($v->vip_download,-4)}}</p>
        <p style="margin-top:5px;">兑换时间:{{$v->created_at}}</p>
        <p style="margin-top:5px;">过期时间:<span style="color:#f60;">{{$v->guoqitime}}</span></p>
      </div>
