...
@section('title')
  {{trans('comm.yinji')}} - {{trans('index.home')}} - {{trans('index.collection_center')}}
@endsection
...
<section class="wrapper">
  <div class="mt30 home_box">
    <div class="title">
      <h2 class="fl"><span style='border-bottom:2px solid #3d87f1;padding-bottom:11px;'>{{trans('index.my_collection')}}</span></h2>
      <span class="fr"><a href="javascript:;" data-type="collect" class="create-new-folder">+ {{trans('index.create')}}</a></span> </div>
