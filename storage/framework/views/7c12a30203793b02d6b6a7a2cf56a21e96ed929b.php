...
<section class="section-wrap">
    <div class="section section-1" style="background:url(/uploads/<?php echo e($lists->bgimg); ?>) top center">
        <div class="title">
            <div class="titles"><img src="/uploads/<?php echo e($lists->logoimg); ?>" alt="地产详情LOGO"></div>
            <div class=" loupan_js waper_box">
                <h1><?php echo e($lists->name); ?></h1>
                <h3><?php echo $lists->intro; ?></h3>
            </div>
        </div>
    </div>
        ...
        <div class="title">
            ...
            <div class="Div1">
                ...
                <div class="Div1_main">
                    <div class="design">
                        <ul>
                        <?php $__currentLoopData = $designer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a href="/designer/<?php echo e($designers->static_url); ?>" target='_blank'><img src="/uploads/<?php echo e($designers->special_photo); ?>" /></a></li>
    ...
    <?php if($lists->jz_display): ?>
    <?php $__currentLoopData = $jz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section section-3">
        <div class="section-3bj"  style=" background:url(<?php echo e(get_article_thum($v)); ?>) no-repeat;background-size:100%100%;"></div>
        <div class="title">
            <div class="titles" >建筑设计 <p>Marketing Center</p> </div>
            <div class="wenjiang" >
                <div class="wenjiang_img" ><img style='height:387px;' src="<?php echo e(get_article_thum($v)); ?>" alt="<?php echo e(get_article_title($v)); ?>"></div>
                <div class="wenjiang_neirong">
                    <h2><?php echo e(get_article_title($v)); ?></h2>
                    <ul class="mt20">
                    <li>
                        <div class="atar_Show">
                            <p tip='<?php echo e($v->article_avg?sprintf("%.1f",$v->article_avg):"5.0"); ?>' style="width: 144px;margin-top: 0;"></p>
                        </div>
                        <span>&nbsp;&nbsp;<?php echo e($v->article_avg?sprintf("%.1f",$v->article_avg):"5.0"); ?>分</span>
                    </li>
                    </ul>
                    <p style='max-height:150px;width: 500px;overflow: hidden;'><?php echo e(get_article_description($v)); ?></p>
                    <div class="wenjiang_more"> <a target="_blank" href="/article/<?php echo e($v->static_url); ?>" target='_blank'>Learn more →</a></div>
                    <div class="" style="right:0; bottom:0; position:absolute; color:#999; font-size:16px;"><i class="icon-eye"></i> <?php echo e($v->view_num); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if($lists->yxzx_display): ?>
    <?php $__currentLoopData = $yxzx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section section-4">
        <div class="section-3bj"  style=" background:url(<?php echo e(get_article_thum($v)); ?>) no-repeat;background-size:100%100%;"></div>
        <div class="title">
            <div class="titles">样板房<p> Residential </p></div>
            <div class="interior_dafen" style='position: relative;left: -555px;top: 445px;'><span class='dcpf'><?php echo e(sprintf("%.1f",$v->article_avg)); ?></span></div>
            <div class="wenjiang" style="background-color:#333">
                <div class="wenjiang_img" ><img style='height:387px;' src="<?php echo e(get_article_thum($v)); ?>" alt="<?php echo e(get_article_title($v)); ?>"> </div>
                <div class="wenjiang_neirong">
                    <h2 style="color:#ccc"><?php echo e(get_article_title($v)); ?></h2>
                    <p style='max-height:90px;width: 500px;overflow: hidden;'><?php echo e(get_article_description($v)); ?></p>
                    <div class="Residential_ico">
                        <a href="javascript:;" class="icon-heart-1" score='<?php echo e($v->id); ?>'>Score</a>
                        <a href="javascript:;"  class="icon-bookmark" article_id='<?php echo e($v->id); ?>'>Collection </a>
                        <a href="javascript:;" class="icon-download" article_id='<?php echo e($v->id); ?>'>download</a>
                    </div>
                    <div class="wenjiang_more">  <a target="_blank" href="/article/<?php echo e($v->static_url); ?>">Learn more →</a></div>
                    <div class="" style="right:0; bottom:0; position:absolute; color:#999; font-size:16px;"><i class="icon-eye"></i> <?php echo e($v->view_num); ?></div>
                </div>
            </div>
        </div>
    ...
    <?php if($lists->gq_display): ?>
    <?php $__currentLoopData = $gq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($lists->ybf_display): ?>
    <?php $__currentLoopData = $ybf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($lists->yl_display): ?>
    <?php $__currentLoopData = $yl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="section section-6">
        <div class="section-3bj"  style=" background:url(<?php echo e(get_article_thum($v)); ?>) no-repeat;background-size:100%100%;"></div>
        <div class="title">
            <div class="titles">园林<p> Residential </p></div>
            <div class="wenjiang" style="background-color:#333">
                <div class="wenjiang_img" ><img style='height:387px;' src="<?php echo e(get_article_thum($v)); ?>" alt="文章封面"> </div>
                <div class="wenjiang_neirong">
                    <h2 style="color:#ccc"><?php echo e(get_article_title($v)); ?></h2>
                    <p style='max-height:90px;width: 500px;overflow: hidden;'><?php echo e(get_article_description($v)); ?></p>
                    <div class="Residential_ico">
    ...
    <div class="section section-7">
        ...
        <div class="huxing swiper-container">
            <ul class="swiper-wrapper">
                <?php $__currentLoopData = $lists->hxtimg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="swiper-slide"><img class="thumb" src="/uploads/<?php echo e($v); ?>" style="display: block;"> </a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
...
<ul class="section-btn">
    <li class="on"></li>
    <li></li>
    <?php if($lists->jz_display): ?> <?php $__currentLoopData = $jz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
    <?php if($lists->yxzx_display): ?> <?php $__currentLoopData = $yxzx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
    <?php if($lists->gq_display): ?> <?php $__currentLoopData = $gq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
    <?php if($lists->ybf_display): ?> <?php $__currentLoopData = $ybf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
    <?php if($lists->yl_display): ?> <?php $__currentLoopData = $yl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
    <?php if($lists->hxt_display): ?> <li></li> <?php endif; ?>
</ul>
...
<div class="arrow">&laquo;</div>
    ...
    <div class="comments">
        <div class="pingfen">
            <p style='font-size: 16px;width: 90%;margin: 0 auto 20px;'><?php echo e(trans('article.comments')); ?><button type="button" class="closecomment">&times;</button></p>
            ...
            <div class="But"> 
                <span class='submitcomment' data-comment-type="article"><?php echo e(trans('article.published')); ?></span> <img src="/images/qq/ico-biaoqing.png" class='bq'/> 
                <p style=" color:#ccc;position: absolute;left: 36px;">（<?php echo e(trans('article.optional')); ?>）</p>         
                    <!--face begin--> 
