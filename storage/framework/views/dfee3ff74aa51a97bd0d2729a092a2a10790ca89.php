<?php $__env->startSection('title'); ?>
  <?php echo e(trans('comm.yinji')); ?> - <?php echo e(trans('index.home')); ?> - <?php echo e(trans('index.collection_center')); ?>
...
<section class="wrapper">
  <div class="mt30 home_box">
    <div class="title">
      <h2 class="fl"><span style='border-bottom:2px solid #3d87f1;padding-bottom:11px;'><?php echo e(trans('index.my_collection')); ?></span></h2>
      <span class="fr"><a href="javascript:;" data-type="collect" class="create-new-folder">+ <?php echo e(trans('index.create')); ?></a></span> </div>
