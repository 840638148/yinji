<?php $__env->startSection('title'); ?>
    ...
    <?php echo e(trans('comm.yinji')); ?>- <?php echo e(trans('index.the_article_to_promote')); ?>
...
<div class="about_nav">
  ...
  <ul>
    ...
    <li  class="current"><a href="/vip/promotion"><?php echo e(trans('index.the_article_to_promote')); ?></a></li>

    <li><a href="/vip/ad"><?php echo e(trans('index.advertising_cooperation')); ?></a></li>

    <!--<li><a href="vip_service.html">会员服务</a></li>-->
    <li><a href="/vip/vip_service"><?php echo e(trans('index.membership_service')); ?></a></li>

    <li><a href="/vip/job_service"><?php echo e(trans('index.recruitment_services')); ?></a></li>
