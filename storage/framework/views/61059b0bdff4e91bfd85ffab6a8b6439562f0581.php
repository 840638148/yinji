...
<header class="mobile_header hide">
    <section class="mheader_main header_animated headroom--top headroom--not-bottom"> 
        ...
        <!--LOGO-->
        <h1 style='width:155px;border-right:1px solid rgba(255,255,255,.3);'> <a href="/" class="logo" title="发现全球设计之美-<?php echo e(trans('comm.yinji')); ?>"><img src="/images/logo.png" alt="<?php echo e(trans('comm.yinji')); ?>" style='margin-top:18px;'></a> </h1>
        <!--LOGOend--> 
    </section>
</header>
        ...
        <ul class="menu">
            ...
            <li class="menu-item menu-item-search"  style=" border-left: 1px solid #fff; border-left-color: rgba(255,255,255,.3);"> 
                ...
                <!---li> <a href="/member"> 个人中心</a> </li>
                    ...
                    <li> <a href="/member/porfile"> 编辑资料</a> 
                </li-->
    ...
    <div class="header-menu right phc_head_menu">
        <ul class="menu">
            ...
            <li id="menu-item-2670" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2670"> 
                <a href="/estate" class="top_nav_link" style='width:95px;'>
                    <div class="cube_container">
                        <div class="backer">Estate</div>
...
<section class="copyright">
    <div class="wrapper">
        <div class="social fl"><a href="/static/about.html"><?php echo e(trans('index.about_us')); ?></a> | <a href="/static/bqbh.html"><?php echo e(trans('index.copyright_protection')); ?></a> | <a href="/static/flsm.html"><?php echo e(trans('index.legal_notices')); ?></a>  | <a href="/static/map.html"><?php echo e(trans('index.site_map')); ?></a></div>

        Copyright © 2016-<?php echo date('Y'); ?> 印际 / Yinji.space / 粤ICP备17108593号

        <div class="social fr">
            <?php echo e(trans('index.follow')); ?>：<a href="https://weibo.com/yinjispace"><img src="/images/foot_31.gif" alt="新浪微博"></a>
