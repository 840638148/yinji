            ...
            <div class="design_3">
                ...
                <ul>
                  ...
                  <!----  <?php if($is_like): ?>
                    ...
                    <?php endif; ?>---->
                    <?php if($designer->company_id): ?>
                    <li style="margin-left:0;width:32.85%;"><i class="icon-share"></i><?php echo e(trans('designer.share')); ?>
                        ...
                        <li id='zp' class="have-disalbed"><a href="/job/detail/<?php echo e($designer->companyids); ?>"><i class="icon-bookmark "></i><?php echo e(trans('designer.job')); ?></a> </li>
                        

                        <?php if($is_subscription): ?>
                            <li style="width:32.85%;" class="have-disalbed"><i class="icon-bookmark "></i><?php echo e(trans('designer.subscribed')); ?></li>
                        <?php else: ?>
                            <li style="width:32.85%;" class="subscription_designer"><i class="icon-bookmark"></i><?php echo e(trans('designer.subscription')); ?></li>
                        <?php endif; ?>

                    <?php else: ?>

                        <li><i class="icon-share"></i><?php echo e(trans('designer.share')); ?>
                        ...
                        <?php if($is_subscription): ?>
                            <li style=" border-right:none;" class="have-disalbed"><i class="icon-bookmark "></i><?php echo e(trans('designer.subscribed')); ?></li>
                        <?php else: ?>
                            <li style=" border-right:none;" class="subscription_designer"><i class="icon-bookmark"></i><?php echo e(trans('designer.subscription')); ?></li>
                        <?php endif; ?>
            ...
            <?php $__currentLoopData = $related_designers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$related_designer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($key < 3): ?>
                    <li class="layout_li ajaxpost">
                        ...
                        <?php if($related_designer->designersavg): ?>
                        <?php echo e(sprintf("%.1f",$related_designer->designersavg)); ?>
