<?php $__env->startSection('title'); ?>
    ...
    VIP_<?php echo e(trans('comm.yinji')); ?> - 续费中心
    ...
    <div class="members_bj">
        <div class="wrapper">
            ...
            <div class="members_box" style="position: relative">
                <div style="position: absolute; top:20px; right: 20px;"><?php echo e(substr($user->expire_time,0,10)); ?>到期</div>
                <div class="members_top"><img src="<?php if($user->avatar): ?> <?php echo e($user->avatar); ?> <?php else: ?> /img/avatar.png <?php endif; ?>" alt="<?php echo e($user->nickname); ?>"></div>
                <div class="members_name"><?php echo e($user->nickname); ?></div>
                <hr>
                <div class="members_info">
                    <ul>
                        <li><i class="ico_vip1"><img src="<?php if($user->level==1): ?> /images/32vip_03.png <?php elseif($user->level==2): ?> /images/32vip_05.png <?php else: ?> /images/32vip_07.png <?php endif; ?> " alt="月VIP会员"></i>月VIP会员</li>
                        <li><i class="ico_vip1"><img src="/images/v_r_<?php echo e($user->vip_level); ?>.png" alt="会员V1"></i>会员等级</li>
                        <li><i><?php echo e($user->points); ?></i>我的积分</li>
                    </ul>
                </div>
            </div>
        </div>
