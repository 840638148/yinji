...
<div class="search_box">
    ...
    <div class="search_nav_bj">
        ...
        <div class="wrapper">
            ...
            <div class="search_nav_right">  <input  id="keywords" name="keywords" type="text" placeholder="输入搜索的关键词" value="<?php echo e($keyword); ?>"> <a href="#" class="icon-search-1 fr" id="search-btn"></a></div>
    ...
    <div class="wrapper" style=" padding-top:20px">
        ...
        <div class="mt30 search-result">
            ...
            <div class="title">
                ...
                <h2>相关设计师 <span>共找到<?php echo e($designers->total()); ?>条结果</span></h2>

            </div>



            <div class="public_list"> <?php $__currentLoopData = $designers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="public_item" data-id="<?php echo e($designer->id); ?>">

                        <div class="item_left"> <a href="<?php if($designer->static_url): ?> /designer/<?php echo e($designer->static_url); ?> <?php else: ?> /designer/detail/<?php echo e($designer->id); ?> <?php endif; ?>" title="<?php echo e(get_designer_title($designer)); ?>" target="_blank">
                            ...
                            <div class="item_msg">
                                ...
                                <div class="title"> <a href="<?php if($designer->static_url): ?> /designer/<?php echo e($designer->static_url); ?> <?php else: ?> /designer/detail/<?php echo e($designer->id); ?> <?php endif; ?>" title="<?php echo e(get_designer_title($designer)); ?>" target="_blank"><?php echo e(get_designer_title($designer)); ?></a> </div>
                        ...
                        <div class="item_right"> <?php $__currentLoopData = $designer->articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt30 search-result">
            ...
            <div class="title">
                ...
                <h2>相关作品 <span>共找到<?php echo e($articles->total()); ?>条结果</span></h2>
        ...
        <div class="search-result">
            ...
            <div class="title">
                ...
                <h2>相关新闻 <span>共找到<?php echo e($newses->total()); ?>条结果</span></h2>
