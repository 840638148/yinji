...
<div id="login" style="height:530px;"> 
  ...
  <p class="fl backtoblog" style='float:left;margin-top:0;'> <a href="/"> ← <?php echo e(trans('login.return')); ?> </a> </p>
  <p id="nav" class="nav fr" style='margin-top:0;'> <a href="/user/register"><?php echo e(trans('login.register')); ?></a> | <a href="/user/forgot_password"><?php echo e(trans('login.forgot_password')); ?></a> </p>
  <!--VIP专栏提示-->
