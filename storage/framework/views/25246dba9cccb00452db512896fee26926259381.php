<?php $__env->startSection('title'); ?>
  <?php echo e(trans('comm.yinji')); ?> - <?php echo e(trans('index.home')); ?>
...
<div class="home_top">
  ...
  <div class="home_nav">
    <ul>
	      ...
	      <li class="current"><a  href="/member"><?php echo e(trans('index.home')); ?></a></li>
  ...
  <div class="mt30 home_box">
    <div class="order_center">
      <ul>
        ...
        <li class="order1"><a href="/member/<?php echo e($user->id); ?>"><?php echo e(trans('index.home')); ?></a><i class="order1_bj"></i> </li>
        <li class="order2"><a href="/vip/intro"><?php echo e(trans('index.become_a_member')); ?></a><i class="order1_bj"></i> </li>
        <li class="order3"><a href="/member/point"><?php echo e(trans('index.my_points')); ?></a><i class="order1_bj"></i> </li>
        <li class="order4 bookInSign"><a href="javascript:;"><?php echo e(trans('index.sign_in')); ?></a></li>
      </ul>
    </div>
    <div class="title">
      <h2><?php echo e(trans('index.my_subscription')); ?></h2>
    </div>
    <div class="designer">
      <ul>
    ...
    <div class="title mt30">
      <h2><?php echo e(trans('index.my_attention')); ?></h2>
    </div>
    <div class="designer">
      <ul>
    ...
    <div class="title  mt30">
      <h2 class="fl"><?php echo e(trans('index.my_finder')); ?></h2>
      <span class="fr"><a href="/member/finder"><?php echo e(trans('index.more')); ?></a></span>
    </div>
    ...
    <div class="title  mt30">
      ...
      <h2 class="fl"><?php echo e(trans('index.my_collection')); ?></h2>
      <span class="fr"><a href="/member/collect"><?php echo e(trans('index.more')); ?></a></span> </div>
...
<div class="sign_integral_box" style=" height:100px;">
  <div class="left integral" style="width:400px;">
    ...
    <h2 class="left">印币：<span id="user-point"><?php echo e($user->points); ?></span>分</h2>
...
<div class="record_box tab_box">
  ...
  <div class="shuomin">说明：连续签到可获得<?php echo e(trans('index.more')); ?>积 ，本站印币可增加下载次数和会员费用抵扣。<br>
...
<div class="change_box tab_box">
  <div class="change">
    <table style="text-align:center;margin-top:30px;">
      ...
      <tr><td colspan='9'>说明：签到最终印币=基础印币+会员额外印币+等级额外印币，节日<?php echo e(trans('index.more')); ?>惊喜等着你哦！</td></tr>
    </table>
  </div>
</div>
<!--------签到规则结束--------->
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        if(IS_VIP){
            $('.order_center .order2').find('a').html('<?php echo e(trans("index.the_member_center")); ?>')
...
<div class='txxx' style='width: 340px;height: 445px;background: #fff;position:absolute;top:40%;left: 40%;z-index:9999;padding:20px;border-radius: 10px;display:none;'>
  <form id="info-form" class="contribute_form" role="form" method="POST" action="/member/one_check"  onsubmit="return checkforms()">
    <p style="width:292px;">  
      <label for="nickname">
        <input type="text" id='nickname' value="<?php echo e($user->nickname); ?>" placeholder='请填写昵称' style="height:46px;border-radius: 5px;">
      </label>  
  ...
  $(function() {  
    //页面初始，加载所有的省份  
      $.ajax({  
          type: "post",  
          url: "/member/citysjld",  
          data: {"type":1,_token: "<?php echo e(csrf_token()); ?>"},  
          dataType: "json",  
          success: function(data) {  
    ...
    $("#provinces").change(function() {  
        $.ajax({  
            type: "post",  
            url: "/member/citysjld",
            data: {"pnum": $(this).val(),"type":2,_token: "<?php echo e(csrf_token()); ?>"},  
            dataType: "json",  
            success: function(data) {  
                //遍历json数据，组装下拉选框添加到html中
