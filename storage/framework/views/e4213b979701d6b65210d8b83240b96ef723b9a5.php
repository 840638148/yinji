...
<?php $__env->startSection('content'); ?>
  ...
  <div class="cat-wrap left mt20">
      ...
      <ul>
          ...
          <p><?php echo e(get_article_title($next_news)); ?></p>
            ...
            <div style="margin-bottom:50px;" class="new_article"> <img src="<?php echo e(get_article_thum($new_news[0])); ?>"   alt="<?php echo e(get_article_title($new_news[0])); ?>" /> <a href="/news/detail/<?php echo e($new_news[0]->id); ?>"><?php echo e(trans('article.latest')); ?></a>
      ...
      <div class="qq_liuyan">
                <h2 class="left">留言</h2>
                <span class=" right">共<span class=" c_red"><?php echo e(isset($comments_total) ? $comments_total : '0'); ?></span>条留言</span> </div>
      <div class="msgCon"> <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="msgBox">
          <dl>
                    <dt><img src="/img/avatar.png" width="50" height="50"></dt>
                    <dd><?php echo e($comment->user->nickname); ?> <i>vip1</i><span>发布于：<?php echo e($comment->created_at); ?></span></dd>
      ...
      <div class="But"> <span class='submit' data-comment-type="news">发表</span> <img src="/images/qq/ico-biaoqing.png" class='bq'/>  -->
            ...
            $("span.submit").click(function(){
                ...
                var comment_id = '<?php echo e($news->id); ?>';
  ...
  <div class="sidebar right cat4_sidebar" style="margin-top:-220px;position: absolute;right: 50%;margin-right: -600px;">
      ...
      <div class="item author-info">
          ...
          <?php if($is_subscription): ?> <span class="Button have-disalbed designer" url="#" title="设计师订阅" designer_id="<?php echo e($designer->id); ?>">已订阅 </span> <?php else: ?> <span class="Button3 wpfp_designer_act designer" url="#" title="设计师订阅" designer_id="<?php echo e($designer->id); ?>">订阅</span> <?php endif; ?>
  ...
  <div class="collection_to">
      ...
      <li>
                ...
                <span img="" floder_id="<?php echo e($key); ?>" class="folderattr null" title="<?php echo e($value); ?>"></span> <a href=" " class="Button2 fr to_find_floder_act add_finder_btn" data-id="<?php echo e($key); ?>" data-img="" data-source="<?php echo e($news->id); ?>">收藏</a > </li>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
          </div>
