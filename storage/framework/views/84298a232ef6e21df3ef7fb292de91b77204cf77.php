<?php $__env->startSection('title'); ?>
  ...
  <?php echo e(trans('comm.yinji')); ?> - 个人资料中心
      ...
      <div id="myTab1_Content0" >
        <form id="info-form" class="contribute_form" role="form" method="POST" action="/member/edit">
          ...
          <p>
            ...
            保密
            <input name="sex" type="radio" value="1" <?php if('1' == $user->
            sex): ?> checked="checked" <?php endif; ?>/>男
            <input name="sex" type="radio" value="2" <?php if('2' == $user->
            sex): ?> checked="checked" <?php endif; ?>/>女 </p>
          <p>
      ...
      <div id="myTab1_Content1"  class="none">
        <form id="pass-form" class="contribute_form" role="form" method="post" action="/member/edit">
          ...
          <p>
            ...
            <input type="text" id="mobile" name="mobile" value="<?php echo e($user->mobile); ?>" >
          </p>
          <p>
            <label for="email">电子邮件</label>
            <input type="text" id="email" name="email" value="<?php echo e($user->url); ?>" >
          </p>
          <p>
