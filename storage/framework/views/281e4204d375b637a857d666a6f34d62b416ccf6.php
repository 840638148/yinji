<?php $__env->startSection('title'); ?>
    <?php echo e(trans('comm.yinji')); ?> - <?php echo e(get_dc_title($article)); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('seo_verification'); ?>
    <?php echo e(get_dc_title($article)); ?>

<?php $__env->stopSection(); ?>


<?php $__env->startSection('seo_description'); ?>
    <?php echo e(get_dc_description($article)); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('seo_keywords'); ?>
    <?php echo e(get_dc_keyword($article)); ?>
...
<style>.users{min-height: 216px;visibility: hidden;}</style>
    ...
    <div class="banner" style="background-image:url(<?php echo e(get_dc_special($article)); ?>);">
        <div class="banner_bj"></div>
        <section class="wrapper banner_title">
            <div class="new_title">
                <h1 class="cfff"><?php echo e(get_dc_title($article)); ?></h1>
                <div class="new_label mt20"> 
                    ...
                    <span> 
                        <?php if($article->article_source): ?>
                            ...
                            <?php if($article->article_source_url): ?> 
                            <a target="_blank" href="<?php echo e($article->article_source_url); ?>"><?php echo e($article->article_source); ?></a>
                            <?php else: ?>
                    ...
                    <ul class="show_number clearfix">
                        <li>
                            <div class="atar_Show">
                                <p tip="<?php echo e($starsav ? sprintf('%.1f',$starsav) : '5.0'); ?>"></p>
                            </div>
                            <span></span>
                        </li>
                    </ul>
                ...
                <div class="news_keyword mt10"><?php echo e(trans('article.keyword')); ?>：<?php echo e(get_dc_keyword($article)); ?>  
                    <!--地点--> 
                    <span class="comment"><i class="icon-location"></i><?php if('zh-CN' == $lang): ?> <?php echo e($article->area); ?> <?php else: ?> <?php echo e($article->area_en); ?> <?php endif; ?></span> 
                    <!--收藏次数--> 
...
<!------顶部大图结束----->
    ...
    <section class="wrapper ">
        <div class="cat-wrap left">
            <div class="content-post" ca="<?php echo e($article->id); ?>"> <?php echo get_dc_content($article); ?> </div>
            <!---------新闻内容结束-------->
            <div class="new_25">
                <ul>      
                    ...
                    <?php endif; ?>
                    <li>
                        <i class="icon-share"></i><?php echo e(trans('article.share')); ?>
                        ...
                        <div class="fenbox">
                            ...
                            <div class="fenxiang">
                                <ul>
                                    ...
                                    <li> <a target="_blank" href="https://service.weibo.com/share/share.php?url=<?php echo e(url('/article/detail/' . $article->id)); ?>&amp;title=【<?php echo e(get_dc_title($article)); ?>】&nbsp; &nbsp; &nbsp; &nbsp;<?php echo get_dc_description($article); ?>&nbsp;@印际&amp;appkey=&amp;pic=&amp;searchPic=true" title="分享到新浪微博" class="weibo" rel="nofollow"> <img src="/images/foot_31.gif" alt="分享到新浪微博" /> </a> </li>
                                    <li> <a target="_blank" href="https://connect.qq.com/widget/shareqq/index.html?url=<?php echo e(url('/article/detail/' . $article->id)); ?>&amp;title=<?php echo e(get_dc_title($article)); ?>&amp;desc=&amp;summary=&nbsp; &nbsp; &nbsp; &nbsp;<?php echo get_dc_description($article); ?>&amp;site=印际" title="分享到QQ好友" class="qq" rel="nofollow"> <img src="/images/foot_35.gif" alt="分享到QQ好友" /> </a> </li>
                                    <li> <a target="_blank" href="https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=<?php echo e(url('/article/detail/' . $article->id)); ?>&amp;title=<?php echo e(get_dc_title($article)); ?>&amp;desc=&amp;summary=&nbsp; &nbsp; &nbsp; &nbsp;<?php echo get_dc_description($article); ?>&amp;site=印际" title="分享到QQ空间" class="qqzone" rel="nofollow"> <img src="/images/foot_37.gif" alt="分享到空间" /> </a> </li>
                                </ul>
                            </div>
                        </div>
                    </li>
                    ...
                    <li style=" border-right:none" id="vip-download"> 
                        <a href="javascript:void(0)" ><i class="icon-download"></i><?php echo e(trans('article.down')); ?></a>
        ...
        <div class="article">
            <ul>
                ...
                <li> 
                    <img src="<?php echo e(get_dc_thum($previous_article)); ?>" alt="<?php echo e(get_dc_title($previous_article)); ?>" /> <a href="/details/<?php echo e($previous_article->id); ?>"><?php echo e(trans('article.previous')); ?></a>
                    <p><?php echo e(get_dc_title($previous_article)); ?></p>
                </li>
                <?php endif; ?>
                    
                <?php if($next_article): ?>
                <li> 
                    <img src="<?php echo e(get_dc_thum($next_article)); ?>" alt="<?php echo e(get_dc_title($next_article)); ?>" /> <a href="/details/<?php echo e($next_article->id); ?>"><?php echo e(trans('article.next')); ?></a>
                    <p><?php echo e(get_dc_title($next_article)); ?></p>
                </li>
                <?php endif; ?>
            </ul>
        </div>
        ...
        <div class="new_article"> 
            <img src="<?php echo e(get_dc_thum($new_article)); ?>" alt="<?php echo e(get_dc_title($new_article)); ?>" /> <a href="/details/<?php echo e($new_article->id); ?>"><?php echo e(trans('article.latest')); ?></a>
        <p><?php echo e(get_dc_title($new_article)); ?></p>
        </div>
        ...
        <div id="qq">
            ...
            <div class="msgCon"> 
                ...
                <div class="msgBox">
                    ...
                    <dl>
                        ...
                        <dd>
                            <span style="float:left"><?php echo e($comment->user->nickname); ?><img src="<?php echo e(App\User::getVipLevel($comment->user->id)); ?>" alt=""></span>
                            <ul class="show_number clearfix" style=" float:left;margin:10px 0 0 30px;">
                                <li style="width:200px;">
                                    <div class="atar_Show2"><p tip="<?php echo e($comment->stars); ?>"></p></div>
                                    <span></span>
                                </li>
                            </ul>  
            ...
            <div class="But"> 
                <span class='submit' data-comment-type="article"><?php echo e(trans('article.published')); ?></span> 
        ...
        <div class="sidebar right cat4_sidebar" style="margin-top:-220px;position:absolute;right: 50%;margin-right: -600px;">
            ...
            <article id="slongposts-2" class="sidebar_widget box widget_salong_posts wow bounceInUp triangle animated" style="visibility: visible; animation-name: bounceInUp;">
                <div class="sidebar_title"><h3><?php echo e(trans('designer.related_article')); ?></h3></div>
                <ul>
                    ...
                    <li>
                        <article class="postlist">
                            <figure> <a href="<?php if($article->static_url): ?> /article/<?php echo e($article->static_url); ?> <?php else: ?> /article/detail/<?php echo e($article->id); ?> <?php endif; ?>" title="<?php echo e(get_dc_title($article)); ?>" target="_blank"> <img class="thumb" src="<?php echo e(get_dc_thum($article)); ?>" data-original="<?php echo e(get_dc_thum($article)); ?>" alt="<?php echo e(get_dc_title($article)); ?>" style="display: block;"> </a> </figure>
                            <h3> <a href="/article/detail/<?php echo e($article->id); ?>" title="<?php echo e(get_dc_title($article)); ?>" target="_blank"><?php echo e(get_dc_title($article)); ?></a> </h3>
                            <div class="homeinfo"> 
                                <!--分类--> 
                                <?php if($article->category): ?>
                                ...
                                <?php endif; ?> 
                                <span class="date"><?php echo e(str_limit($article->release_time, 10, '')); ?></span> <span title="请先浏览本文章，再确定是否点赞！" class="like"><i class="icon-thumbs-up"></i><span class="count"><?php echo e($article->like_num); ?></span></span> 
                            </div>
                        </article>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="sidebar right">
                <section class="label_right_title"><h2><?php echo e(trans('index.hot_tags')); ?></h2></section>
                <div class="label">
                    <ul>
        ...
        <div class="collection_to">
            ...
            <?php $__currentLoopData = $user_finder_folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <h3><?php echo e($value['name']); ?></h3>
                    <span img='' floder_id='<?php echo e($value["id"]); ?>'  class='folderattr null' title='<?php echo e($value["name"]); ?>'> </span> 
                    <div id="modal_btns"> <a href='' class='Button2 fr to_find_floder_act add_finder_btns' data-id='<?php echo e($value["id"]); ?>' data-img='' data-source=''>收藏</a> </div>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
