<?php $__env->startSection('title'); ?>
 <?php echo e(trans('comm.yinji')); ?> - TA <?php echo e(trans('index.discovery_detail')); ?>
...
<section class="wrapper" style='width:1245px;'>
    ...
    <!-- 内容开始 -->
        <div class="box"> 
            <?php $__currentLoopData = $users->finder_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i =>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="itemww"> 
                    <img src="<?php echo e($v['photo_url']); ?>" data-id="<?php echo e($v['user_finder_folder_id']); ?>" source='<?php echo e($v["photo_source"] ? $v["photo_source"] : $v["dcarticle_id"]); ?>' data-photo-index="<?php echo e($i); ?>" alt="<?php echo e(mb_substr($v['titlename'],0,30)); ?>">
                    <?php if($v['photo_source']): ?>
                    <div class="titlename" onclick="location='<?php if($v['static_url']): ?> /article/<?php echo e($v['static_url']); ?> <?php else: ?> /article/detail/<?php echo e($v['id']); ?> <?php endif; ?>'">
                    <?php else: ?>
                    <div class="titlename" onclick="location='/details/<?php echo e($v['dcarticle_id']); ?>'">
                    <?php endif; ?>
                    <?php if(strlen($v['titlename']) < 20): ?> <?php echo e($v['titlename']); ?> <?php else: ?> <?php echo e(mb_substr($v['titlename'],0,20)); ?> <?php endif; ?></div>
                    <div class="scbtm" photoid="<?php echo e($v['photo_source']?$v['photo_source']:$v['dcarticle_id']); ?>" imgsrc="<?php echo e($v['photo_url']); ?>" data-id='<?php echo e($v["photo_source"] ? $v["photo_source"] : $v["dcarticle_id"]); ?>' data-pid-i="<?php echo e($i); ?>" onclick="getID(this)"><img style='width:20px;height:20px;margin-top:7px;' src="data:image/png;base64," alt=""></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
        </div>
    <!-- 内容结束 -->
        ...
        <div class="showscbtn">
            ...
            <div class="collection_to">
                ...
                <li>
                    ...
                    <div id="modal_btns"> <a href='javascript:void(0);' class='Button2 to_find_floder_acts asd' scid='<?php echo e($value["id"]); ?>'  data-img='' >收藏</a> </div>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.scbtm',function(ev){
            ...
            let user_finder_folder_id = $('.to_find_floder_acts ').attr('scid');//发现的收藏夹id
            let folder_ids = [];
        ...
        //点击收藏按钮进行收藏
        $(document).on('click','.to_find_floder_acts',function(ev){
            if(!IS_LOGIN){
                $('.login_box').show();
            }else{
            var that=$(this);
            ...
            $.ajax({
                    ...
                    success: function (data){
                        if(data.status_code == 0){
                            ...
                            that.removeClass('to_find_floder_acts');
