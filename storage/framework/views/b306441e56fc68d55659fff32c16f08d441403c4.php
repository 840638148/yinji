<?php $__env->startSection('title'); ?>
 <?php echo e(trans('comm.yinji')); ?> - <?php echo e(trans('index.home')); ?> - <?php echo e(trans('index.discovery_detail')); ?>
...
<div class="swiper-container swiper-home">
    ...
    <article class="swiper-slide slide-single" data-swiper-slide-index="<?php echo e($loop->iteration); ?>"> 
		<div class="wrap" style="position: relative;">
			<img id="btntp" width="600px" height="600px" src="<?php echo e($v['photo_url']); ?>" data-id="<?php echo e($v['photo_source']); ?>" alt="<?php echo e($v['name']); ?>">
		</div>
    </article>
    ...
    <div class="masonry">
      ...
      <div class="item discovery-item " style="display:flex">
        <div class="item_content item_content2">
        		<li> <img src="<?php echo e($detail['photo_url']); ?>" data-id="<?php echo e($detail['user_finder_folder_id']); ?>" source='<?php echo e($detail["photo_source"]); ?>' alt="<?php echo e(mb_substr($detail['titlename'],0,30)); ?>"> </li>
          <div class="find_title">
            <h2><a href="<?php echo e($detail['photo_source']? ('/article/'. $detail['static_url']):'/details/'.$detail['static_url']); ?>" target="_blank"><?php echo e(mb_substr($detail['titlename'],0,20)); ?></a></h2>
            <span class='dot'>•••</span>
            <div class='move_del'>
              <div class='left_sjx'></div>
              <p><a style="padding-top: 1.5px;color:#fff;" source='<?php echo e($detail["photo_source"]); ?>' photo_src="<?php echo e($detail['photo_url']); ?>" href="javascript:;" class="yd_find_img" data-id="<?php echo e($detail['id']); ?>" tag="移动发现的图片到其他文件夹">移动</a></p>
              <p><a style="padding-top: 1.5px;color:#fff;" href="javascript:;" class="remove_find_img" data-id="<?php echo e($detail['id']); ?>" tag="删除发现的图片">删除</a></p>
            </div>
            <div class='fxj' source='' photo_src=''>
              <span class='closefxj' style='padding:5px;font-size: 22px;float: right;cursor: pointer;'>X</span>
              <?php $__currentLoopData = $folderall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
