...
<section class="slides-sticky  wow bounceInUp animated" style="visibility: visible; animation-name: bounceInUp;">
  <section class="slide-main slide-home">
    <div class="swiper-container swiper-home swiper-container-horizontal">
      <div class="swiper-wrapper" style="transform: translate3d(-7876px, 0px, 0px); transition-duration: 0ms;"> <?php $__currentLoopData = $bannar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ban_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="swiper-slide slide-single" data-swiper-slide-index="<?php echo e($loop->iteration); ?>" style="width: 1145.6px;"> <a href="<?php echo e($ban_item->ad_url); ?>" class="swiper-image" style="background-image: url(<?php echo e(url('uploads/' . $ban_item->ad_img)); ?>);"></a> </article>
...
<section class="wrapper">
    ...
    <article class="like">
      <ul>
        ...
        <div class="left like_title">
          <ul>
            <article>
              <figure> <a href="<?php if($article->static_url): ?> /article/<?php echo e($article->static_url); ?> <?php else: ?> /article/detail/<?php echo e($article->id); ?> <?php endif; ?>" title="<?php echo e(get_article_title($article)); ?>" target="_blank"> <img class="thumb" src="<?php echo e(get_article_thum($article)); ?>" style="display: block;"> </a> </figure>
              <h2><a href="<?php if($article->static_url): ?> /article/<?php echo e($article->static_url); ?> <?php else: ?> /article/detail/<?php echo e($article->id); ?> <?php endif; ?>" title="<?php echo e(get_article_title($article)); ?>" target="_blank"> <?php echo e(get_article_title($article)); ?></a></h2>
              <div class="postinfo"> 
  ...
  <div class="sidebar right box">
    ...
    <div class="jobs"><a href="/static/job_service.html" class="jobs_release"> <img src="/images/job_24.gif" width="288" height="115"
      ...
      <?php $__currentLoopData = $joblist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li><a target="_blank" href="/job/detail/<?php echo e($list['id']); ?>">(<?php echo e(mb_substr($list['addr'],0,2)); ?>) <?php echo e(mb_substr($list['company_name'],0,8)); ?> / <?php echo e(mb_substr($list['job_name'],0,10)); ?>...</a></li>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
      </ul>
    </div>
  </div>
