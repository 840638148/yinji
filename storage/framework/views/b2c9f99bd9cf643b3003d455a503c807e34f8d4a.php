...
<section class="wrapper"> 
  ...
  <div class="find_tab"> 
    ...
    <div class="TabTitle">
      <ul id="myTab1">
        <?php if(Session::get('language')=='zh-CN'): ?>
        <li class="active tabka" cate='tjfinder' onclick="nTabs(this,0);"><?php echo e(trans('index.discovery')); ?></li>
        <li class="normal tabka" cate='tjfolder' onclick="nTabs(this,1);">推荐<?php echo e(trans('index.favorites')); ?></li>
        <li class="normal tabka" cate='tjuser' onclick="nTabs(this,2);">推荐<?php echo e(trans('index.users')); ?></li>
        <?php else: ?>
        <li class="active tabka" cate='tjfinder' onclick="nTabs(this,0);"><?php echo e(trans('index.discovery')); ?></li>
        <li class="normal tabka" cate='tjfolder' onclick="nTabs(this,1);"><?php echo e(trans('index.favorites')); ?></li>
        <li class="normal tabka" cate='tjuser' onclick="nTabs(this,2);"><?php echo e(trans('index.users')); ?></li>
        <?php endif; ?>
      </ul>
    </div>
    ...
    function getCollectionItemDom(item){
      ...
      if(item.who_find && item.who_find.length > 0){
        item.who_find.map(function(user,idx){
          h += '   <a href="/member/'+item.user_id+'" class="collect-user-icon"><img id="errimg" src="' + user.userIcon + '" onerror="this.onerror=``;this.src=`/img/avatar.png`" /></a> ';
        })
      }
      h += '  </div>';
      h += ' </div>';
              ...
              if(data.data.content && cates=='tjfinder'){
                ...
                if(data.status_code == 0 && cates=='tjfinder'){
                    ...
                    $.each(list.finders,function(index, item){
                      ...
                      h+='<span> <a href="/member/'+item.user_id+'">'+item.who_find[0].userName+'</a> 收藏到 <a href="#">'+item.who_find[0].folderName+'</a></span></div>';
